...
export const metadata = {
  title: 'New project — pleasejudgemefairly',
}
      ...
      <main className="flex-1 px-4 sm:px-6 py-8 sm:py-12">
        <div className="mx-auto max-w-2xl">
          ...
          <p className="mt-2 text-sm text-stone-600">
            Define the project, its vision, the financial model, and the tier
            structure. No money is collected here — tiers are purely an
            expression-of-interest framework.
          </p>
          <div className="mt-8">
            <NewProjectForm />
          </div>
